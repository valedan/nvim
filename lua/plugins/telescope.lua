return {
{
  ...
  keys = {
    ...
    { "<leader>sw", "<cmd>lua require'telescope.builtin'.grep_string{}<cr>", desc = "Grep String" },
    { "<leader>uc", "<cmd>lua require'telescope.builtin'.colorscheme{enable_preview=true}<cr>", desc = "Colorscheme with preview" },
    { "<leader>ss", "<cmd>lua require'telescope.builtin'.lsp_document_symbols{}<cr>", desc = "Goto Symbol" },
    { "<leader>sS", "<cmd>lua require'telescope.builtin'.lsp_dynamic_workspace_symbols{}<cr>", desc = "Goto Symbol (Workspace)" },
  },
  opts = {
    defaults = {
      prompt_prefix = " ",
